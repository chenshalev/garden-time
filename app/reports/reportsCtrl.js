gardenApp.controller("reportsCtrl", function ($scope, $log, $http, $location, activeUser, tasks, $filter) {
    ...
    $scope.getDate = function(task) {
        ...
        if (task.datedone.length!="") {
            return $filter('date')(task.datedone, "dd/MM/yyyy");
        } else {
            return "";
        }
    }
